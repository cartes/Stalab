                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(datos, function (i, obj) {
                            $('.listSearch').append('<h3 class="list-group-item" data-id="' + obj.id + '"><a href="' + obj.guid + '">' + obj.title + '</a></h3>');
                        });
                    },
    ...
    $('.downloadPDF').click(function () {
        ...
        $('html').animate({scrollTop: 0}, 300, 'linear', function () {
            ...
            pdf.autoTable({
                ...
                didParseCell: function (data) {
                    ...
                    if (data.cell.raw.className === 'logoMarca') {
                        ...
                        var alto = img[0].clientHeight * 0.5;
            ...
            for (var i = 1; i <= numPages; i++) {
                pdf.setPage(i);
                pdf.addImage(logo[0].src, 30, 25, logo[0].clientWidth * 0.5, logo[0].clientHeight * 0.5);
                pdf.setFontSize(8);
